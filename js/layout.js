  ...
  <div class="footer-sponsors">
    <div class="wrapper wrapper--wide footer-sponsors__inner">
      ...
      <a href="https://atomyko.com" target="_blank" rel="noopener noreferrer" aria-label="Atomyko — sitio web (se abre en una pestaña nueva)">
        <img src="assets/img/sponsor-atomyko.png" alt="Atomyko" height="64">
      </a>
    </div>
  </div>
  <div class="wrapper wrapper--wide">
    ...
    <div class="footer-social">
      ...
      <div class="footer-social__links">
        ${social.map(([n, icon]) => `<a href="#" target="_blank" rel="noopener noreferrer"><i class="${icon}" aria-hidden="true"></i><span>${n}</span></a>`).join("")}
      </div>
    </div>
